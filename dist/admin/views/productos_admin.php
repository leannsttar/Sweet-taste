                        ...
                        <div class="bg-white rounded-lg shadow relative dark:bg-[#000]">
                            ...
                            <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="../processes/AddItem.php" method="post">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="descripcion" id="descripcion" placeholder="$20.00" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                                </div>
                                <div>
                                    <label for="precio" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Precio</label>
                                    <input type="number" name="precio" id="precio" placeholder="$20.00" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                                </div>
                            ...
                            <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                                ...
                                <div class="bg-white rounded-lg shadow relative dark:bg-[#000]">
                                    ...
                                    <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="" method="post">
                                        ...
                                        <div>
                                            <label for="precio" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Precio</label>
                                            <input type="number" name="precio" id="precio" value="<?php echo $product['precio']?>" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                                        </div>
