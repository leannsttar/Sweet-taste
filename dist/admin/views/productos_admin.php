            ...
            <div>
                        ...
                        <div class="bg-white rounded-lg shadow relative dark:bg-[#000]">
                            ...
                            <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Nombre del producto" required="">
                                </div>
                                <div>
                                    <label for="password" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Precio</label>
                                    <input type="number" name="password" id="password" placeholder="$20.00" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                                </div>
                                <div>
                                ...
                                <div>
                                    <label for="image" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Imagen</label>
                                    <input type="file" name="image" id="image" placeholder="$20.00" class="after: bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                                </div>
                ...
                <div class="space-y-10">
                    <div class="flex items-center justify-between border-b-4 pb-4">
                        ...
                        <button type="button" data-modal-target="edit-modal" data-modal-toggle="edit-modal"><img src="../images/edit.svg" alt=""></button>

                        <div id="edit-modal" aria-hidden="true" class="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
                            <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                                <!-- Modal content -->
                                <div class="bg-white rounded-lg shadow relative dark:bg-[#000]">
                                    <div class="flex justify-end p-2">
                                    ...
                                    <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                                        ...
                                        <button type="submit" class="w-full text-white bg-red-200 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Editar producto</button>
                                    </form>
                                </div>
                            </div>
                        </div> 
