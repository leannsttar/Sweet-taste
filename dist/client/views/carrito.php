            ...
            <div class="flex space-x-20">
                ...
                <div class="w-[40%]">
                    <div class="bg-[#FA8F88] rounded-t-xl p-8 space-y-5">
                        ...
                        <button class="bg-black border-[1px] border-[black] font-light text-2xl text-white px-4 h-16 w-full hover:bg-white hover:text-black transition-all ease-in-out duration-300">Confirm Order</button>
                    </div>
